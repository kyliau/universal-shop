...
import { JsActionServerModule } from './js-action-server/js-action-server.module'
import { CustomElementsServerModule } from './custom-elements/custom-elements-server.module';
...
@NgModule({
  imports: [
    ...
    JsActionServerModule,
    CustomElementsServerModule,
  ],
  providers: [
